...
class MitraColors {
  ...
  static const List<Color> gradientHero    = [Color(0xFF1a0a3e), Color(0xFF2D1B69), Color(0xFF0f2a1a)];
  static const List<Color> gradientTeacher = [Color(0xFF0a1f0a), Color(0xFF0f2d1f)];
}
